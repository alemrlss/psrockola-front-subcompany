  ...
  resources: {
    en: {
      translation: {
        ...
        view_dashboard_subcompany_no_rockobits_transactions:
          "No rockobits transactions",
        menu_logout: "Logout",
        view_screens_change_password: "Change Password",
        view_screens_show_playlists: "Show Playlists",
        view_screens_change: "Change",
        view_screens_cancel: "Cancel",
        view_screens_new_password: "New Password",
        view_screens_subcompany: "Screens",
        view_screens_loading: "Loading...",
        view_screens_ban_selected: "Ban selected",
        view_screens_ban: "Ban",
        view_screens_loading_playlists: "Loading playlists...",
        view_screens_all_selects: "Select All",
        view_screens_all_unselects: "Unselect All",
        view_screens_confirm_ban: "Confirm Ban",
        view_screens_confirm_ban_message:
          "Are you sure you want to ban this video?",
        view_screens_cancel_ban: "Cancel Ban",
        view_screens_confirm_ban_selected: "Confirm Ban Selected",
        view_screens_confirm_ban_selected_message:
          "Are you sure you want to ban selected videos?",
        view_transactions_distributor: "Transfer to Distributor",
        view_transactions_client: "Transfer to Client",
        view_transactions_qr: "QR Claim",
        view_transactions_loading: "Loading...",
        ...
        view_transactions_no: "No transactions found",
        view_transactions_generate_qr: "Generate QR",
        view_transactions_cancel_qr: "Cancel QR",
        settings_change_password: "Change Password",
        settings_change_update_photo: "Update Profile Photo",
        ...
        settings_photo_upload: "Upload Photo",
        view_transactions_rows_per_page: "Rows per page",
      },
    },
    es: {
      translation: {
        ...
        view_dashboard_subcompany_no_rockobits_transactions:
          "No hay transacciones de rockobits",

        menu_logout: "Cerrar sesión",
        view_screens_change_password: "Cambiar Contraseña",
        view_screens_show_playlists: "Mostrar Listas de Reproducción",
        view_screens_change: "Cambiar",
        view_screens_cancel: "Cancelar",
        view_screens_new_password: "Nueva Contraseña",
        view_screens_subcompany: "Pantallas",
        view_screens_loading: "Cargando...",
        view_screens_ban_selected: "Banear seleccionados",
        view_screens_ban: "Banear",
        view_screens_loading_playlists: "Cargando listas de reproducción...",
        view_screens_all_unselects: "Deseleccionar todo",
        view_screens_all_selects: "Seleccionar todo",
        view_screens_confirm_ban: "Confirmar Ban",
        view_screens_confirm_ban_message:
          "¿Estás seguro de banear a este video?",
        view_screens_cancel_ban: "Cancelar Ban",
        view_screens_confirm_ban_selected: "Confirmar Ban Seleccionado",
        view_screens_confirm_ban_selected_message:
          "¿Estás seguro de banear los videos seleccionados?",
        view_transactions_distributor: "Transferir a Distribuidor",
        view_transactions_client: "Transferir a Cliente",
        view_transactions_qr: "Reclamo QR",
        view_transactions_loading: "Cargando...",
        ...
        view_transactions_no: "No se encontraron transacciones",
        view_transactions_generate_qr: "Generar QR",
        view_transactions_cancel_qr: "Cancelar QR",
        settings_change_password: "Cambiar Contraseña",
        settings_change_update_photo: "Cambiar Foto",
        settings_password_current: "Contraseña Actual",
        settings_password_new: "Nueva Contraseña",
        settings_password_confirm: "Confirma Nueva Contraseña",
        settings_password_change: "Cambiar",
        settings_photo_upload: "Cargar Foto",
        view_transactions_rows_per_page: "Filas por página",
      },
    },
    pt: {
      translation: {
        ...
        view_dashboard_subcompany_no_rockobits_transactions:
          "Nenhuma transação de rockobits",
        menu_logout: "Sair",
        view_screens_change_password: "Alterar Senha",
        view_screens_show_playlists: "Mostrar Listas de Reprodução",
        view_screens_change: "Alterar",
        view_screens_cancel: "Cancelar",
        view_screens_new_password: "Nova Senha",
        view_screens_subcompany: "Telas",
        view_screens_loading: "Carregando...",
        view_screens_ban_selected: "Banir selecionados",
        view_screens_ban: "Banir",
        view_screens_loading_playlists: "Carregando listas de reprodução...",
        view_screens_all_selects: "Selecionar Todos",
        view_screens_all_unselects: "Deselecionar Todos",
        view_screens_confirm_ban: "Confirmar Banimento",
        view_screens_confirm_ban_message:
          "Tem certeza de que deseja banir este vídeo?",
        view_screens_cancel_ban: "Cancelar Banimento",
        view_screens_confirm_ban_selected: "Confirmar Banimento Selecionado",
        view_screens_confirm_ban_selected_message:
          "Tem certeza de que deseja banir os vídeos selecionados?",
        view_transactions_distributor: "Transferir para Distribuidor",
        view_transactions_client: "Transferir para Cliente",
        view_transactions_qr: "Reivindicar QR",
        view_transactions_loading: "Carregando...",
        view_transactions_table_date: "Data",
        view_transactions_table_type: "Tipo",
        view_transactions_table_amount: "Quantidade",
        view_transactions_table_user: "Usuário",
        view_transactions_no: "Nenhuma transação encontrada",
        view_transactions_generate_qr: "Gerar QR",
        view_transactions_cancel_qr: "Cancelar QR",
        settings_change_password: "Alterar a senha",
        settings_change_update_photo: "Alterar foto do perfil",
        settings_password_current: "Senha atual",
        settings_password_new: "Nova Senha",
        settings_password_confirm: "Confirme a nova senha",
        settings_password_change: "Mudar",
        settings_photo_upload: "Carregar foto",
        view_transactions_rows_per_page: "Linhas por página",
      },
    },
  },
  lng: storedLanguage,
